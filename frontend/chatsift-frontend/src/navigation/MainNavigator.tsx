...
function SidebarNavigator() {
  ...
  const go = (name: string) => {
    ...
    if (navigationRef.isReady()) {
      (navigationRef.navigate as any)('Main', { screen: name });
    }
  };

  const items: SidebarItem[] = [
    { key: 'Dashboard', label: 'Dashboard', icon: 'view-dashboard', active: activeRoute === 'Dashboard', onPress: () => go('Dashboard') },
    { key: 'Integrations', label: 'Integrations', icon: 'connection', active: activeRoute === 'Integrations', onPress: () => go('Integrations') },
    { key: 'Monitoring', label: 'Monitoring', icon: 'monitor', active: activeRoute === 'Monitoring', onPress: () => go('Monitoring') },
    { key: 'Summaries', label: 'Summaries', icon: 'file-document', active: activeRoute === 'Summaries', onPress: () => go('Summaries') },
    { key: 'Settings', label: 'Settings', icon: 'cog', active: activeRoute === 'Settings', onPress: () => go('Settings') },
  ];
